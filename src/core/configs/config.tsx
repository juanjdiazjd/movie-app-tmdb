...
export const SUPPORT_NOTCH = Platform.OS === 'ios' || (Platform.OS === 'android' && Platform.Version >= 23);
export const IS_ANDROID = Platform.OS === 'android';
export const IS_IOS = Platform.OS === 'ios';

export const HAS_NOTCH = DeviceInfo.hasNotch();

const showToast = (type: ToastType, text1: string, text2: string, showText?: boolean) =>
  Toast.show({
    autoHide: false,
    type,
    text1: text1 || '',
